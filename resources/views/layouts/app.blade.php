    ...
    <div id="app">
        ...
        <footer class="w-full text-white">
            ...
            <div style="background-color: #D65A1F;"> {{-- Atau #F2A51A, atau gradien jika diinginkan --}}
                ...
                {{-- Strip Warna Oranye Kemerahan di Paling Bawah --}}
                <div class="w-full py-2" style="background-color: #d35400;"> {{-- Atau #E05A15 --}}
                    {{-- Bisa diisi teks tambahan atau dibiarkan kosong sebagai aksen warna --}}
                </div>
        </footer>
    </div>
