...
<body style="background: radial-gradient(circle, #F2A51A 0%, #EA6227 70%, #d35400 100%);" data-spy="scroll"
    data-target="#guide-nav" data-offset="120">
    <div id="app" class="z-60 w-full"
        ...
        <header class="w-full z-50 text-sm py-4">
            <nav class="relative max-w-7xl w-full flex items-center justify-between mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="hidden md:flex items-center gap-x-2">
                    {{-- Link Home sekarang kondisional --}}
                    @guest
                        <a class="font-semibold py-2 px-3 rounded-lg transition-colors {{ request()->routeIs('landing') ? 'bg-yellow-400 text-indigo-950' : 'text-yellow-100 hover:bg-yellow-500/20' }}"
                            ...
                            <div id="dropdownAvatarName"
                                ...
                                <ul class="py-2 text-sm text-indigo-900" aria-labelledby="dropdownAvatarNameButton">
                                    <li><a href="{{ route('profile.edit') }}"
                                            class="flex items-center gap-x-2 px-4 py-2 hover:bg-yellow-200">Profile</a></li>
                                </ul>
                                <div class="py-1">
                                    <a href="{{ route('logout') }}"
                    ...
                    @auth
                        <div class="border-t border-orange-400/50 pt-4 mt-2">
                            ...
                            <a href="{{ route('logout') }}"
                                ...
                                class="block w-full text-center py-2 px-3 rounded-lg bg-red-600/80 text-white font-semibold hover:bg-red-700">Logout</a>
