...
@section('content')
    ...
    <div
        ...
        <div
            ...
            <div class="text-center md:text-left">
                ...
                <a href="#"
                    class="z-60 inline-block bg-indigo-900 hover:bg-indigo-950 text-yellow-100 font-semibold py-2 px-4 sm:py-3 sm:px-6 rounded-lg text-sm sm:text-base transition duration-150"style="font-family: 'Poppins', cursive; letter-spacing: -0.03em;">
                    Mulai Sekarang &gt;
                </a>
            </div>
        ...
        <div class="absolute bottom-[-70px] -z-60 text-center w-full ">
            <script type="module" src="https://unpkg.com/@splinetool/viewer@1.9.98/build/spline-viewer.js" async></script>
            {{-- <spline-viewer loading-anim-type="spinner-small-light"
                url="https://prod.spline.design/g9fY1TzK6xQEu6Hl/scene.splinecode"><img
                    ...
                    alt="Spline preview" style="width: 100%; height: 100%;" /></spline-viewer> --}}
        </div>
    ...
    {{-- SECTION SERVICES --}}
    <div class="z-60 w-full py-12 sm:py-16 md:py-20 lg:py-24 px-4"
        style="background: radial-gradient(circle, #F2A51A 0%, #EA6227 70%, #d35400 100%);">
        <div class="max-w-6xl mx-auto text-center">
            <h2
                class="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-yellow-100 mb-3 sm:mb-4 relative inline-block pb-1 sm:pb-2"style="font-family: 'Baloo Bhaijaan 2', cursive; font-weight: 200; letter-spacing: -0.04em;">
                Services.
            </h2>
            <p class="text-sm sm:text-base lg:text-lg text-yellow-100 max-w-xs sm:max-w-md md:max-w-lg lg:max-w-2xl mx-auto mb-8 sm:mb-12 md:mb-16"
                style="font-family: 'Poppins', cursive; letter-spacing: -0.03em;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 lg:gap-12">
                ...
                <div
                    class="group p-6 sm:p-8 pb-4 rounded-3xl text-yellow-100 transform hover:scale-105 transition-transform duration-300">
                    <div class="rounded-[35px] h-[200px] sm:h-[220px] md:h-[200px] lg:h-[250px] flex items-center justify-center p-1 transition-all duration-300 group-hover:shadow-[0_0_25px_8px_#091057]"
                        style="background: radial-gradient(circle , #1423BD 0%, #091057 100%);">
                        <img src="{{ asset('storage/images/clock.png') }}" alt="Timer Icon"
                            class="max-h-[50%] sm:max-h-[60%] w-auto">
                    </div>
                    <h3 class="text-xl sm:text-2xl lg:text-3xl font-semibold mb-2 sm:mb-3 mt-4 sm:mt-6"
                        style="font-family: 'Poppins', cursive;">Timer
                    </h3>
                ...
                <div
                    class="group p-6 sm:p-8 pb-4 rounded-3xl text-yellow-100 transform hover:scale-105 transition-transform duration-300">
                    <div class="rounded-[35px] h-[200px] sm:h-[220px] md:h-[200px] lg:h-[250px] flex items-center justify-center p-1 transition-all duration-300 group-hover:shadow-[0_0_25px_8px_#1423BD]"
                        style="background: radial-gradient(circle , #091057 0%, #1423BD 100% );">
                        <img src="{{ asset('storage/images/task.png') }}" alt="Manage Task Icon"
                            class="max-h-[50%] sm:max-h-[60%] w-auto">
                    </div>
                    <h3 class="text-xl sm:text-2xl lg:text-3xl font-semibold mb-2 sm:mb-3 mt-4 sm:mt-6"
                ...
                <div
                    ...
                    <div class="rounded-[35px] h-[200px] sm:h-[220px] md:h-[200px] lg:h-[250px] flex items-center justify-center p-1 transition-all duration-300 group-hover:shadow-[0_0_25px_8px_#091057]"
                        style="background: radial-gradient(circle , #1423BD 0%, #091057 100%);">
                        <img src="{{ asset('storage/images/rank.png') }}" alt="Rank Icon"
                            class="max-h-[50%] sm:max-h-[60%] w-auto">
                    </div>
                    <h3 class="text-xl sm:text-2xl lg:text-3xl font-semibold mb-2 sm:mb-3 mt-4 sm:mt-6"
                        style="font-family: 'Poppins', cursive;">Rank
                    </h3>
                    <p class="text-xs sm:text-sm lg:text-base"
                        style="font-family: 'Poppins', cursive; letter-spacing: -0.03em;">
    ...
    <div class="w-full py-12 sm:py-16 md:py-20 lg:py-24 px-4" style="background-color: #091057;">
        <div class="max-w-6xl mx-auto text-center sm:text-left">
            <h2 class="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-yellow-100 mb-3 sm:mb-4 relative inline-block pb-1 sm:pb-2"
                style="font-family: 'Baloo Bhaijaan 2', cursive; font-weight: 200; letter-spacing: -0.04em;">
                Our Teams.
            </h2>
            <p class="text-sm sm:text-base lg:text-lg text-yellow-100 max-w-xs sm:max-w-md md:max-w-xl lg:max-w-3xl mx-auto sm:mx-0 mb-10 sm:mb-12 md:mb-16"
                style="font-family: 'Poppins', cursive; letter-spacing: -0.03em;">
            ...
            <div
                class="relative flex flex-col sm:flex-row flex-wrap justify-center items-center gap-8 lg:gap-12 min-h-[300px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-[600px]">

                {{-- Team Card 1: Fawwaz --}}
                <div
                    class="relative z-20 transform sm:translate-y-[-20px] md:translate-y-[-40px] lg:translate-y-[40px] lg:translate-x-[-100px] group">
                    <div class="w-[240px] sm:w-[260px] md:w-[280px] rounded-[40px] text-center text-yellow-100 shadow-2xl overflow-hidden transform group-hover:scale-105 transition-transform duration-300"
                        style="box-shadow: 0px 15px 35px -5px rgba(242, 165, 26, 0.5), 0px 8px 15px rgba(0,0,0,0.1);">
                        <div class="relative h-[100px] sm:h-[100px] flex justify-center items-end pb-2"
                            style="background-color: #EA6227;">
                            <img src="{{ asset('storage/images/profile_fawwaz.jpg') }}" alt="Fawwaz Aufa A. R."
                                class="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full absolute bottom-[-48px] sm:bottom-[-56px] md:bottom-[-64px] left-1/2 -translate-x-1/2 border-4 sm:border-[6px] border-white object-cover shadow-lg">
                        </div>
                        <div class="pt-[60px] sm:pt-[70px] md:pt-[78px] pb-5 sm:pb-6 px-4 sm:px-6"
                            style="background-color: #F2A51A;">
                            <h3 class="text-lg sm:text-xl font-semibold mt-1 sm:mt-2 mb-1"
                                style="font-family: 'Poppins', cursive;">
                                Fawwaz Aufa A. R.
                            </h3>
                            <p class="text-xs sm:text-sm text-gray-100 mb-3 sm:mb-4"
                                style="font-family: 'Poppins', cursive;">CEO</p>
                            <div class="flex justify-center sm:justify-start space-x-3 pt-1 sm:pt-2">
                                {{-- SVGs remain the same --}}
                                <a href="https://www.instagram.com/fawwzrf._?igsh=ZTRicHZqYzlnOGw2"
                                    class="text-gray-200 hover:text-yellow-100"><svg xmlns="http://www.w3.org/2000/svg"
                                        aria-hidden="true" fill="currentColor" width="20" height="20"
                                        viewBox="0 0 50 50">
                                        <path
                                            d="M 16 3 C 8.83 3 3 8.83 3 16 L 3 34 C 3 41.17 8.83 47 16 47 L 34 47 C 41.17 47 47 41.17 47 34 L 47 16 C 47 8.83 41.17 3 34 3 L 16 3 z M 37 11 C 38.1 11 39 11.9 39 13 C 39 14.1 38.1 15 37 15 C 35.9 15 35 14.1 35 13 C 35 11.9 35.9 11 37 11 z M 25 14 C 31.07 14 36 18.93 36 25 C 36 31.07 31.07 36 25 36 C 18.93 36 14 31.07 14 25 C 14 18.93 18.93 14 25 14 z M 25 16 C 20.04 16 16 20.04 16 25 C 16 29.96 20.04 34 25 34 C 29.96 34 34 29.96 34 25 C 34 20.04 29.96 16 25 16 z">
                                        </path>
                                    </svg></a>
                                <a href="https://www.github.com/Fawwzrf" class="text-gray-200 hover:text-yellow-100"><svg
                                ...
                                <a href="https://www.linkedin.com/in/fawwazrf" class="text-gray-200 hover:text-yellow-100"><svg
                                        xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20"
                                        viewBox="0,0,256,256">
                                        <g fill="#fffdfd" fill-rule="nonzero" stroke="none" stroke-width="1"
                                            stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10"
                ...
                {{-- Team Card 2: Revalina --}}
                <div
                    class="relative z-10 transform sm:translate-y-[0px] md:translate-y-[20px] lg:translate-y-[-120px] group">
                    <div class="w-[240px] sm:w-[260px] md:w-[280px] rounded-[40px] text-center text-yellow-100 shadow-2xl overflow-hidden transform group-hover:scale-105 transition-transform duration-300"
                        style="box-shadow: 0px 15px 35px -5px rgba(242, 165, 26, 0.5), 0px 8px 15px rgba(0,0,0,0.1);">
                        <div class="relative h-[100px] sm:h-[100px] flex justify-center items-end pb-2"
                            style="background-color: #EA6227;">
                        ...
                        <div class="pt-[60px] sm:pt-[70px] md:pt-[78px] pb-5 sm:pb-6 px-4 sm:px-6"
                            ...
                            <p class="text-xs sm:text-sm text-gray-100 mb-3 sm:mb-4"
                                style="font-family: 'Poppins', cursive;">Founder</p>
                            <div class="flex justify-center sm:justify-start space-x-3 pt-1 sm:pt-2">
                                {{-- SVGs remain the same --}}
                                ...
                                <a href="https://github.com/revalinafa" class="text-gray-200 hover:text-yellow-100"><svg
                                        xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20"
                                        viewBox="0,0,256,256">
                                        <g fill="#fffdfd" fill-rule="nonzero" stroke="none" stroke-width="1"
                                            stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10"
                                ...
                                <a href="https://www.linkedin.com/in/revalina-fidiya-anugrah05?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                                    class="text-gray-200 hover:text-yellow-100"><svg xmlns="http://www.w3.org/2000/svg" x="0px"
                ...
                {{-- Team Card 3: Isma --}}
                <div
                    class="relative z-0 transform sm:translate-y-[20px] md:translate-y-[80px] lg:translate-y-[40px] lg:translate-x-[100px] group">
                    <div class="w-[240px] sm:w-[260px] md:w-[280px] rounded-[40px] text-center text-yellow-100 shadow-2xl overflow-hidden transform group-hover:scale-105 transition-transform duration-300"
                        style="box-shadow: 0px 15px 35px -5px rgba(242, 165, 26, 0.5), 0px 8px 15px rgba(0,0,0,0.1);">
                        <div class="relative h-[100px] sm:h-[100px] flex justify-center items-end pb-2"
                            style="background-color: #EA6227;">
                        ...
                        <div class="pt-[60px] sm:pt-[70px] md:pt-[78px] pb-5 sm:pb-6 px-4 sm:px-6"
                            ...
                            <p class="text-xs sm:text-sm text-gray-100 mb-3 sm:mb-4"
                                style="font-family: 'Poppins', cursive;">CTO</p>
                            <div class="flex justify-center sm:justify-start space-x-3 pt-1 sm:pt-2">
                                {{-- SVGs remain the same --}}
                                <a href="http://instagram.com/needmadhira" class="text-gray-200 hover:text-yellow-100"><svg
                                ...
                                <a href="http://github.com/IsmaFdz" class="text-gray-200 hover:text-yellow-100"><svg
                                        xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20"
                                        viewBox="0,0,256,256">
                                        <g fill="#fffdfd" fill-rule="nonzero" stroke="none" stroke-width="1"
                                            stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10"
                                ...
                                <a href="#" class="text-gray-200 hover:text-yellow-100"><svg
                                        xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20"
                                        viewBox="0,0,256,256">
                                        <g fill="#fffdfd" fill-rule="nonzero" stroke="none" stroke-width="1"
                                            stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10"
    ...
    <div class="w-full py-12 sm:py-16 md:py-20 lg:py-24 overflow-hidden" style="background-color: #091057;">
        <div class="max-w-6xl mx-auto text-center">
            <h2 class="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-yellow-100 mb-2 relative inline-flex items-center"
                style="font-family: 'Baloo Bhaijaan 2', cursive; font-weight: 200; letter-spacing: -0.02em;">
                <span class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl mr-2 sm:mr-4 text-orange-400">&lt;</span>
                Client Testimonials
                <span class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl ml-2 sm:ml-4 text-orange-400">&gt;</span>
            </h2>

            <div id="testimonialClientCarouselFlowbite" class="relative w-full mt-8 sm:mt-10 md:mt-12"
                data-carousel="slide">
                {{-- Adjusted height for different screens --}}
                <div
                    class="relative h-[480px] xs:h-[520px] sm:h-[580px] md:h-[650px] lg:h-[700px] overflow-hidden rounded-lg">

                    {{-- Item Carousel 1: ALFAN di Tengah --}}
                    <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                        <div
                            class="flex justify-center items-center h-full gap-x-1 sm:gap-x-2 md:gap-x-3 lg:gap-x-4 py-6 sm:py-8 px-1">
                            {{-- Kartu Kiri (Defit - Kecil, Redup) --}}
                            <div class="testimonial-card-flowbite-side transform scale-80 xs:scale-85 sm:scale-90 md:scale-85 opacity-75 w-[180px] xs:w-[200px] sm:w-[240px] md:w-[280px] p-3 sm:p-4 md:p-6 text-left text-yellow-100 transition-all duration-300"
                                ...
                                <div
                                    class="relative h-[60px] sm:h-[70px] md:h-[80px] flex justify-center items-end mb-[-15px] sm:mb-[-20px] md:mb-[-25px]">
                                    <img src="{{ asset('storage/images/profile_defit.jpg') }}" alt="Defit Bagus"
                                        class="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-full absolute top-6 sm:top-8 left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 sm:border-4 border-[#D65A1F] object-cover shadow-md z-10">
                                </div>
                                <div class="pt-[30px] sm:pt-[35px] md:pt-[40px]">
                                    <h3 class="text-sm sm:text-md md:text-lg font-semibold mt-1 mb-1 text-center"
                                        style="font-family: 'Poppins', cursive;">Defit Bagus</h3>
                                    <p class="text-[10px] sm:text-xs text-gray-300 mb-1 sm:mb-2 text-center"
                                        style="font-family: 'Poppins', cursive;">Pak Lurah</p>
                                    <div class="relative mt-1">
                                        <p class="text-[9px] sm:text-[10px] md:text-xs italic"
                                            style="font-family: 'Poppins', cursive; line-height: 1.4 sm:line-height:1.5;">
                            ...
                            <div class="testimonial-card-flowbite-center transform scale-100 opacity-100 w-[220px] xs:w-[260px] sm:w-[300px] md:w-[340px] lg:w-[380px] p-4 sm:p-6 md:p-8 text-left text-yellow-100 transition-all duration-300"
                                ...
                                <div
                                    class="relative h-[80px] sm:h-[100px] md:h-[120px] flex justify-center items-end mb-[-25px] sm:mb-[-30px] md:mb-[-35px]">
                                    <img src="{{ asset('storage/images/profile_alfan.jpg') }}" alt="Alfan Fauzan"
                                        class="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 rounded-full absolute top-10 sm:top-12 left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 sm:border-4 border-[#E05A15] object-cover shadow-lg profile-glow">
                                </div>
                                <div class="pt-[50px] sm:pt-[55px] md:pt-[60px]">
                                    <h3 class="text-md sm:text-lg md:text-xl lg:text-2xl font-semibold mt-2 mb-1 text-center"
                                        style="font-family: 'Poppins', cursive;">Alfan Fauzan</h3>
                                    <p class="text-xs sm:text-sm text-gray-200 mb-2 sm:mb-3 text-center"
                                        style="font-family: 'Poppins', cursive;">Mahasiswa</p>
                                    <div class="relative mt-1">
                                        <p class="text-xs sm:text-sm md:text-base italic"
                                            style="font-family: 'Poppins', cursive; line-height: 1.5 sm:line-height: 1.6;">
                        ...
                        <div
                            ...
                            <div class="testimonial-card-flowbite-side transform scale-80 xs:scale-85 sm:scale-90 md:scale-85 opacity-75 w-[180px] xs:w-[200px] sm:w-[240px] md:w-[280px] p-3 sm:p-4 md:p-6 text-left text-yellow-100 transition-all duration-300"
                                ...
                                <div
                                    class="relative h-[60px] sm:h-[70px] md:h-[80px] flex justify-center items-end mb-[-15px] sm:mb-[-20px] md:mb-[-25px]">
                                    <img src="{{ asset('storage/images/profile_alfan.jpg') }}" alt="Alfan Fauzan"
                                        class="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-full absolute top-6 sm:top-8 left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 sm:border-4 border-[#E05A15] object-cover shadow-md z-10">
                                </div>
                                <div class="pt-[30px] sm:pt-[35px] md:pt-[40px]">
                                    <h3 class="text-sm sm:text-md md:text-lg font-semibold mt-1 mb-1 text-center"
                                        style="font-family: 'Poppins', cursive;">Alfan Fauzan</h3>
                            ...
                            <div class="testimonial-card-flowbite-center transform scale-100 opacity-100 w-[220px] xs:w-[260px] sm:w-[300px] md:w-[340px] lg:w-[380px] p-4 sm:p-6 md:p-8 text-left text-yellow-100 transition-all duration-300"
                                ...
                                <div
                                    class="relative h-[80px] sm:h-[100px] md:h-[120px] flex justify-center items-end mb-[-25px] sm:mb-[-30px] md:mb-[-35px]">
                                    <img src="{{ asset('storage/images/profile_bina.jpg') }}" alt="Bina Jenner"
                                        class="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 rounded-full absolute top-10 sm:top-12 left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 sm:border-4 border-[#D65A1F] object-cover shadow-lg profile-glow">
                                </div>
                                <div class="pt-[50px] sm:pt-[55px] md:pt-[60px]">
                                    <h3 class="text-md sm:text-lg md:text-xl lg:text-2xl font-semibold mt-2 mb-1 text-center"
                                        style="font-family: 'Poppins', cursive;">Bina Jenner</h3>
                    ...
                    {{-- Carousel Controls --}}
                    <button type="button"
                        class="absolute top-1/2 -translate-y-1/2 start-0 z-30 flex items-center justify-center h-full px-2 sm:px-4 cursor-pointer group focus:outline-none"
                        data-carousel-prev>
                        <span
                            class="inline-flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/30 group-hover:bg-white/50 group-focus:ring-2 sm:group-focus:ring-4 group-focus:ring-white/70 group-focus:outline-none">
                            <svg class="w-3 h-3 sm:w-4 sm:h-4 text-orange-400 rtl:rotate-180" aria-hidden="true"
                    ...
                    <button type="button"
                        class="absolute top-1/2 -translate-y-1/2 end-0 z-30 flex items-center justify-center h-full px-2 sm:px-4 cursor-pointer group focus:outline-none"
                        data-carousel-next>
                        <span
                            class="inline-flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/30 group-hover:bg-white/50 group-focus:ring-2 sm:group-focus:ring-4 group-focus:ring-white/70 group-focus:outline-none">
                            <svg class="w-3 h-3 sm:w-4 sm:h-4 text-orange-400 rtl:rotate-180" aria-hidden="true"
        ...
        {{-- SECTION FAQ BARU --}}
        <div class="w-full py-12 sm:py-16 md:py-20 lg:py-24 px-4" style="background-color: #091057;">
            <div class="max-w-4xl mx-auto"> {{-- Max-width disesuaikan --}}
                <h2 class="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold text-yellow-100 mb-8 sm:mb-12 md:mb-16 text-center sm:text-left"
                    style="font-family: 'Baloo Bhaijaan 2', cursive; font-weight: 200; letter-spacing: -0.02em;">
                    FAQs
                </h2>
                ...
                <div id="accordion-faq-pomocat" data-accordion="collapse"
                    ...
                    <h2 id="accordion-faq-heading-1">
                        <button type="button"
                            class="flex items-center justify-between w-full p-4 sm:p-5 md:p-6 font-medium rtl:text-right border-b border-indigo-800 transition-colors duration-200 ease-in-out"
                            data-accordion-target="#accordion-faq-body-1" aria-expanded="false"
                            aria-controls="accordion-faq-body-1">
                            <span class="text-base sm:text-lg lg:text-xl"
                                style="font-family: 'Poppins', sans-serif;">Apakah PomoCat
                                bisa diakses di perangkat apa saja?</span>
                            <svg data-accordion-icon
                                class="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 rotate-0 shrink-0 transition-transform duration-200"
                    ...
                    <div id="accordion-faq-body-1" class="hidden" aria-labelledby="accordion-faq-heading-1">
                        <div class="p-4 sm:p-5 md:p-6 border-b border-indigo-800 bg-orange-500">
                            <p class="mb-2 text-slate-900 text-xs sm:text-sm md:text-base"
                                style="font-family: 'Poppins', sans-serif; line-height: 1.6 sm:line-height: 1.7;">
                    ...
                    <h2 id="accordion-faq-heading-2">
                        <button type="button"
                            class="flex items-center justify-between w-full p-4 sm:p-5 md:p-6 font-medium rtl:text-right border-b border-indigo-800 transition-colors duration-200 ease-in-out"
                            data-accordion-target="#accordion-faq-body-2" aria-expanded="true"
                            aria-controls="accordion-faq-body-2">
                            <span class="text-base sm:text-lg lg:text-xl"
                                style="font-family: 'Poppins', sans-serif;">Bagaimana cara
                                kerja timer di PomoCat?</span>
                            <svg data-accordion-icon
                                class="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 shrink-0 transition-transform duration-200"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="M9 5 5 1 1 5" />
                            </svg>
                    ...
                    <div id="accordion-faq-body-2" class="hidden" aria-labelledby="accordion-faq-heading-2">
                        <div class="p-4 sm:p-5 md:p-6 border-b border-indigo-800 bg-orange-500">
                            ...
                            <p class="text-slate-900 text-xs sm:text-sm md:text-base"
                                style="font-family: 'Poppins', sans-serif; line-height: 1.6 sm:line-height: 1.7;">
                    ...
                    <h2 id="accordion-faq-heading-3">
                        <button type="button"
                            ...
                            <span class="text-base sm:text-lg lg:text-xl" style="font-family: 'Poppins', sans-serif;">Apa
                                itu fitur
                    ...
                    <div id="accordion-faq-body-3" class="hidden" aria-labelledby="accordion-faq-heading-3">
                        <div class="p-4 sm:p-5 md:p-6 border-b border-indigo-800 bg-orange-500">
                            <p class="mb-2 text-slate-900 text-xs sm:text-sm md:text-base"
                                style="font-family: 'Poppins', cursive; line-height: 1.6 sm:line-height: 1.7;">
                    ...
                    <div id="accordion-faq-body-4" class="hidden" aria-labelledby="accordion-faq-heading-4">
                        <div class="p-4 sm:p-5 md:p-6 bg-orange-500"> {{-- Item terakhir tidak perlu border-b --}}
                            <p class="mb-2 text-slate-900 text-xs sm:text-sm md:text-base"
                                style="font-family: 'Poppins', cursive; line-height: 1.6 sm:line-height: 1.7;">
